...
import CombinatorialGames.Misere.Utils
...
theorem rightEnd_rightWinsGoingFirst {g : IGame} (h1 : IsRightEnd g) : RightWinsGoingFirst g := by
  unfold RightWinsGoingFirst
  exact Or.inl h1
